...
export default function POS() {
  ...
  return (
    <div className="container max-w-screen-2xl overflow-x-hidden px-3 py-3 sm:px-4 sm:py-4 landscape:py-2">
      ...
      <div className="fixed inset-x-0 z-40 border-t border-border/60 glass-strong px-3 py-2 shadow-elevated md:hidden landscape:bottom-0 landscape:pb-[env(safe-area-inset-bottom)]" style={{ bottom: "calc(4rem + env(safe-area-inset-bottom))" }}>
